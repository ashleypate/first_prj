...
class CourseEnrollController extends ApiController
{
    ...
    public function searchStudents()
    {
        ...
        $moet_unit_id = isset($this->data['moet_unit_id']) ? $this->data['moet_unit_id'] : null;
        $students = $this->userRepository->getUserByRole($studentRole->_id, ($pages - 1) * $size, $size, $keyword_search, null, false, $moet_unit_id, $user_ignore);
